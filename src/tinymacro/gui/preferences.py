...
class PreferencesDialog(QDialog):
    ...
    def _build_general_tab(self) -> QWidget:
        ...
        self.check_updates_on_startup.setChecked(s.check_updates_on_startup)
        ...
        form.addRow("Check for updates on startup", self.check_updates_on_startup)
    ...
    def _accept(self) -> None:
        try:
            ...
            s.check_updates_on_startup = self.check_updates_on_startup.isChecked()
